...
xst -ifn xst.scr
move system_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\system_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc system_pll_exdes.ucf system_pll_exdes

echo 'Running map'
map -timing -pr b system_pll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm system_pll_exdes -w routed.ncd routed.v
cd ..
